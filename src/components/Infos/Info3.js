  ...
  return (
    <div className={`contentsBox sa anime_scaleUp ${act === 1 ? "show" : ""}`} >
      <div className="content background column">
        ...
        <div className="flex_area_row height_per80 border_top">
          <div className="flex_area_row height_per100 width_per45 border_right">
            <div className="technic_list width_per100 flex_area_column height_per100">
              {/* 여기에는 사용한 중요 라이브러리/기술 리스트 */}
              <div className="text_center width_per100 height_per10">
                사용한 중요 기술
              </div>
          ...
          <div className="flex_area_row height_per100 width_per45">
            <div className="technic_list width_per100 flex_area_column height_per100">
              <div className="text_center width_per100 height_per10">
                참고 자료
              </div>
        ...
        <div className="flex_area_row width_per100 height_per10 border_top">
