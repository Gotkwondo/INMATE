    ...
    <div className={`contentsBox sa anime_scaleUp ${act === 1 ? "show" : ""}`} >
      <div className="content background column">
        ...
        <div className="flex_area_row height_per80 border_top">
          <div className="flex_area_row height_per100 border_right">
            <div className="technic_list width_per100 flex_area_column">
          ...
          <div className="flex_area_row height_per100">
            <div className="technic_list width_per100 flex_area_column">
              <div className="text_center width_per100">
                참고 자료
              </div>
