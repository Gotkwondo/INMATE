  ...
  return (
    <div className="main_contents">
      <div className="main_contents_list">
        <GifAnimation url="/INMATE/maplist" img={mapStaticImg} text="인천 맛집 지도" gif={mapGif} use={"main"} />
        <GifAnimation url="/INMATE/info" img={infoStatic} text="웹의 정보" gif={infoGif } use={"main"} />
      </div>
    </div>
  );
};
